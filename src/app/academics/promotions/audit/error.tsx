...
export default function AcademicPromotionAuditError() {
  return (
    <AppShell>
      <div className="erp-container">
        <Card className="mx-auto max-w-xl">
          <SectionHeader eyebrow="Promotion Audit" title="Promotion audit unavailable" />
          <div className="p-4 sm:p-5">
            <EmptyState description="Promotion audit evidence could not be loaded. Check the filters and try again." title="Promotion audit unavailable" />
