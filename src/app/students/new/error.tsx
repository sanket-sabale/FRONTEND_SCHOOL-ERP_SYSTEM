...
export default function StudentCreateError({ reset }: { reset: () => void }) {
  return (
    <AppShell>
      <Card className="mx-auto max-w-xl p-5">
        <SectionHeader eyebrow="Student Management" title="Unable to load admission form" />
        <div className="p-4 sm:p-5">
          <EmptyState
            description="Please retry. If this continues, ask your school administrator to review the current academic context."
            title="Unable to load student admission form"
          />
