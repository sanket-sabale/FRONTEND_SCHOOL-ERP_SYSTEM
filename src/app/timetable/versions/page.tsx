...
import { TimetableVersionsView } from "@/features/timetable/components/timetable-resource-views";
...
export default async function TimetableVersionsPage() {
  ...
  return <AppShell><TimetableVersionsView context={{ school: tenantContext.school, campus: tenantContext.campus, academicYear: tenantContext.academicYear }} data={data} /></AppShell>;
}
