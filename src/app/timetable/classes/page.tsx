...
export default async function TimetableClassesPage() {
  ...
  return <AppShell><TimetableResourceView context={{ school: tenantContext.school, campus: tenantContext.campus, academicYear: tenantContext.academicYear }} data={data} mode="classes" /></AppShell>;
}
