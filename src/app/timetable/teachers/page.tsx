...
import { TimetableResourceView } from "@/features/timetable/components/timetable-resource-views";
import { timetableService } from "@/lib/api/timetable";
import { currentSessionRole } from "@/lib/current-user";
import { tenantContext } from "@/lib/tenant-context";

export default async function TimetableTeachersPage() {
  ...
  return <AppShell><TimetableResourceView context={{ school: tenantContext.school, campus: tenantContext.campus, academicYear: tenantContext.academicYear }} data={data} mode="teachers" /></AppShell>;
}
