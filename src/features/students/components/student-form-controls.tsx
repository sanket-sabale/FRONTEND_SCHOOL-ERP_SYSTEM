...
export function StudentTextInput({
  error,
  helperText,
  label,
  name,
...
export function StudentReadOnlyField({ label, value }: { label: string; value: string }) {
  return (
...
export function formatStudentGenderOption(value: string) {
  return value
    .split("_")
