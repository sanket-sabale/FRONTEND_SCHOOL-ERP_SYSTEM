...
export function AttendanceIntegrityRecordNotFound() {
  return (
    <div className="erp-container">
      <Card className="mx-auto max-w-xl">
        <SectionHeader eyebrow="Attendance Integrity" title="Integrity record not found" />
        <div className="p-4 sm:p-5">
          <EmptyState description="The attendance record does not exist or is outside the active attendance scope." title="Record unavailable" />
